...
export class Init1753388043631 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TYPE "public"."service_status_enum" AS ENUM('active', 'inactive')`);
        await queryRunner.query(`ALTER TABLE "service" ADD "status" "public"."service_status_enum" NOT NULL DEFAULT 'active'`);
    }
